...
// DefaultInspectParams 默认审核参数
func DefaultInspectParams() *InspectParams {
	return &InspectParams{
		// TABLE
		MAX_TABLE_NAME_LENGTH:   64,
		CHECK_TABLE_COMMENT:     true,
		TABLE_COMMENT_LENGTH:    256,
		CHECK_IDENTIFIER:        true,
		CHECK_IDENTIFER_KEYWORD: true,
		...
		CHECK_TABLE_AUDIT_TYPE_COLUMNS:       false,
		...
		INNODB_ROW_FORMAT:                    []string{"DYNAMIC", "COMPRESSED"},
		// COLUMN
		MAX_COLUMN_NAME_LENGTH:               64,
		CHECK_COLUMN_CHARSET:                 false,
		CHECK_COLUMN_COMMENT:                 true,
		COLUMN_MAX_CHAR_LENGTH:               20,
		MAX_VARCHAR_LENGTH:                   16383,
		ENABLE_COLUMN_BLOB_TYPE:              false,
		ENABLE_COLUMN_JSON_TYPE:              true,
		ENABLE_COLUMN_BIT_TYPE:               false,
		...
		SECONDARY_INDEX_MAX_KEY_PARTS: 5,
		PRIMARYKEY_MAX_KEY_PARTS:      3,
		MAX_INDEX_KEYS:                10,
		ENABLE_INDEX_RENAME:           false,
		ENABLE_REDUNDANT_INDEX:        false,
		// ALTER
		ENABLE_DROP_COLS:               false,
		ENABLE_DROP_INDEXES:            true,
		ENABLE_DROP_PRIMARYKEY:         false,
		ENABLE_DROP_TABLE:              false,
		ENABLE_TRUNCATE_TABLE:          false,
		ENABLE_RENAME_TABLE_NAME:       false,
		ENABLE_MYSQL_MERGE_ALTER_TABLE: true, // 与老服务保持一致，默认开启MySQL ALTER合并检查
		ENABLE_TIDB_MERGE_ALTER_TABLE:  false,
		// DML
		DML_MUST_HAVE_WHERE:        true,
		DML_DISABLE_LIMIT:          false,
		DML_DISABLE_ORDERBY:        false,
		DML_DISABLE_SUBQUERY:       false,
