...
func LogicCreateTableIsExist(v *traverses.TraverseCreateTableIsExist, r *inspect.RuleHint) {
...
// LogicCreateTableAs
func LogicCreateTableAs(v *traverses.TraverseCreateTableAs, r *inspect.RuleHint) {
	if v.IsCreateAs {
		// 不深入检查AS后面的语法
...
func LogicCreateTableLike(v *traverses.TraverseCreateTableLike, r *inspect.RuleHint) {
	if v.IsCreateLike {
...
func LogicCreateTableOptions(v *traverses.TraverseCreateTableOptions, r *inspect.RuleHint) {
	v.Type = "create"
...
func LogicCreateTablePrimaryKey(v *traverses.TraverseCreateTablePrimaryKey, r *inspect.RuleHint) {
	// 必须定义主键
...
func LogicCreateTableConstraint(v *traverses.TraverseCreateTableConstraint, r *inspect.RuleHint) {
...
func LogicCreateTableAuditCols(v *traverses.TraverseCreateTableAuditCols, r *inspect.RuleHint) {
...
func LogicCreateTableColsOptions(v *traverses.TraverseCreateTableColsOptions, r *inspect.RuleHint) {
...
func LogicCreateTableColsRepeatDefine(v *traverses.TraverseCreateTableColsRepeatDefine, r *inspect.RuleHint) {
	// 查找重复的列名
...
func LogicCreateTableColsCharset(v *traverses.TraverseCreateTableColsCharset, r *inspect.RuleHint) {
	// 列字符集检查
...
func LogicCreateTableIndexesPrefix(v *traverses.TraverseCreateTableIndexesPrefix, r *inspect.RuleHint) {
...
func LogicCreateTableIndexesCount(v *traverses.TraverseCreateTableIndexesCount, r *inspect.RuleHint) {
	// 检查二级索引数量
...
func LogicCreateTableIndexesRepeatDefine(v *traverses.TraverseCreateTableIndexesRepeatDefine, r *inspect.RuleHint) {
	// 查找重复的索引
...
func LogicCreateTableRedundantIndexes(v *traverses.TraverseCreateTableRedundantIndexes, r *inspect.RuleHint) {
...
func LogicCreateTableDisabledIndexes(v *traverses.TraverseCreateTableDisabledIndexes, r *inspect.RuleHint) {
	// BLOB/TEXT类型不能设置为索引
...
func LogicCreateTableInnodbLargePrefix(v *traverses.TraverseCreateTableInnodbLargePrefix, r *inspect.RuleHint) {
...
func LogicCreateTableInnoDBRowSize(v *traverses.TraverseCreateTableInnoDBRowSize, r *inspect.RuleHint) {
...
func LogicCreateTableInnoDBRowFormat(v *traverses.TraverseCreateTableOptions, r *inspect.RuleHint) {
	// 判断行格式
