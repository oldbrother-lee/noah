...
func LogicDisableAuditDMLTables(v *traverses.TraverseDisableAuditDMLTables, r *inspect.RuleHint) {
	// 禁止审核指定的表
...
func LogicDMLInsertIntoSelect(v *traverses.TraverseDMLInsertIntoSelect, r *inspect.RuleHint) {
	if v.IsMatch == 0 {
		return
	}
...
// LogicDMLNoWhere
func LogicDMLNoWhere(v *traverses.TraverseDMLNoWhere, r *inspect.RuleHint) {
	if v.IsMatch == 0 {
		return
	}
...
func LogicDMLInsertWithColumns(v *traverses.TraverseDMLInsertWithColumns, r *inspect.RuleHint) {
	if v.IsMatch == 0 {
		return
	}
...
// LogicDMLHasLimit
func LogicDMLHasConstraint(v *traverses.TraverseDMLHasConstraint, r *inspect.RuleHint) {
	if v.IsMatch == 0 {
		return
	}
...
// LogicDMLJoinWithOn
func LogicDMLJoinWithOn(v *traverses.TraverseDMLJoinWithOn, r *inspect.RuleHint) {
	if v.IsMatch == 0 {
		return
	}
...
func LogicDMLMaxUpdateRows(v *traverses.TraverseDMLMaxUpdateRows, r *inspect.RuleHint) {
	if v.IsMatch == 0 {
		return
	}
...
func LogicDMLMaxInsertRows(v *traverses.TraverseDMLMaxInsertRows, r *inspect.RuleHint) {
	if v.IsMatch == 0 {
		return
	}
