...
func LogicAlterTableIsExist(v *traverses.TraverseAlterTableIsExist, r *inspect.RuleHint) {
...
func LogicAlterTableTiDBMerge(v *traverses.TraverseAlterTiDBMerge, r *inspect.RuleHint) {
	// 检查TiDBMergeAlter
...
func LogicAlterTableDropColsOrIndexes(v *traverses.TraverseAlterTableDropColsOrIndexes, r *inspect.RuleHint) {
	if v.IsMatch == 0 {
		return
	}
	r.MergeAlter = v.Table
...
func LogicAlterTableDropTiDBColWithCoveredIndex(v *traverses.TraverseAlterTableDropTiDBColWithCoveredIndex, r *inspect.RuleHint) {
...
func LogicAlterTableOptions(v *traverses.TraverseAlterTableOptions, r *inspect.RuleHint) {
	if v.IsMatch == 0 {
		return
	}
	r.MergeAlter = v.Table
...
func LogicAlterTableColCharset(v *traverses.TraverseAlterTableColCharset, r *inspect.RuleHint) {
	if v.IsMatch == 0 {
		return
	}
	r.MergeAlter = v.Table
...
func LogicAlterTableAddColAfter(v *traverses.TraverseAlterTableAddColAfter, r *inspect.RuleHint) {
	if v.IsMatch == 0 {
		return
	}
	r.MergeAlter = v.Table
...
func LogicAlterTableAddColOptions(v *traverses.TraverseAlterTableAddColOptions, r *inspect.RuleHint) {
	if v.IsMatch == 0 {
		return
	}
	r.MergeAlter = v.Table
...
func LogicAlterTableAddPrimaryKey(v *traverses.TraverseAlterTableAddPrimaryKey, r *inspect.RuleHint) {
	if v.IsMatch == 0 {
		return
	}
	r.MergeAlter = v.Table
...
func LogicAlterTableAddColRepeatDefine(v *traverses.TraverseAlterTableAddColRepeatDefine, r *inspect.RuleHint) {
	if v.IsMatch == 0 {
		return
	}
	r.MergeAlter = v.Table
...
func LogicAlterTableAddIndexPrefix(v *traverses.TraverseAlterTableAddIndexPrefix, r *inspect.RuleHint) {
	if v.IsMatch == 0 {
		return
	}
	r.MergeAlter = v.Table
...
func LogicAlterTableAddIndexCount(v *traverses.TraverseAlterTableAddIndexCount, r *inspect.RuleHint) {
	if v.IsMatch == 0 {
		return
	}
	r.MergeAlter = v.Table
...
func LogicAlterTableAddConstraint(v *traverses.TraverseAlterTableAddConstraint, r *inspect.RuleHint) {
	if v.IsMatch == 0 {
		return
	}
	r.MergeAlter = v.Table
...
func LogicAlterTableAddIndexRepeatDefine(v *traverses.TraverseAlterTableAddIndexRepeatDefine, r *inspect.RuleHint) {
	if v.IsMatch == 0 {
		return
	}
	r.MergeAlter = v.Table
...
func LogicAlterTableRedundantIndexes(v *traverses.TraverseAlterTableRedundantIndexes, r *inspect.RuleHint) {
	if v.IsMatch == 0 {
		return
	}
...
func LogicAlterTableDisabledIndexes(v *traverses.TraverseAlterTableDisabledIndexes, r *inspect.RuleHint) {
	if v.IsMatch == 0 {
		return
	}
	r.MergeAlter = v.Table
...
func LogicAlterTableModifyColOptions(v *traverses.TraverseAlterTableModifyColOptions, r *inspect.RuleHint) {
	if v.IsMatch == 0 {
		return
	}
	r.MergeAlter = v.Table
...
func LogicAlterTableChangeColOptions(v *traverses.TraverseAlterTableChangeColOptions, r *inspect.RuleHint) {
	/*
		change操作的2种用法
		修改列的类型信息
...
func LogicAlterTableRenameIndex(v *traverses.TraverseAlterTableRenameIndex, r *inspect.RuleHint) {
	if v.IsMatch == 0 {
		return
	}
	r.MergeAlter = v.Table
...
func LogicAlterTableRenameTblName(v *traverses.TraverseAlterTableRenameTblName, r *inspect.RuleHint) {
	if v.IsMatch == 0 {
		return
	}
	r.MergeAlter = v.Table
...
func LogicAlterTableInnodbLargePrefix(v *traverses.TraverseAlterTableInnodbLargePrefix, r *inspect.RuleHint) {
	// 获取db表结构
...
func LogicAlterTableInnoDBRowSize(v *traverses.TraverseAlterTableInnoDBRowSize, r *inspect.RuleHint) {
	if v.IsMatch == 0 {
		return
	}
	r.MergeAlter = v.Table
